        ...
        stage('Deploy Backend to EC2') {
            steps {
                dir('revplay_backend') {
                    ...
                    scp -i /home/ubuntu/revplay-key1.pem -o StrictHostKeyChecking=no target/musicplatform-0.0.1-SNAPSHOT.jar ubuntu@3.109.23.75:/home/ubuntu/
                    ssh -i /home/ubuntu/revplay-key1.pem -o StrictHostKeyChecking=no ubuntu@3.109.23.75 "sudo systemctl restart revplay"
                    '''
                }
            }
        }
