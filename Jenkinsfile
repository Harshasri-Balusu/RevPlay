        ...
        stage('Deploy Backend to EC2') {
            steps {
                dir('revplay_backend') {
                    ...
                    ssh -i /home/ubuntu/revplay-key1.pem -o StrictHostKeyChecking=no ubuntu@3.7.137.29 "nohup java -Dspring.profiles.active=prod -jar /home/ubuntu/musicplatform-0.0.1-SNAPSHOT.jar > app.log 2>&1 &"
                    '''
                }
            }
        }
